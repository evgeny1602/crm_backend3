...
export class Init1625213819852 implements MigrationInterface {
    name = 'Init1625213819852'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "events" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "description" varchar NOT NULL, "start_datetime" datetime NOT NULL, "process_datetime" datetime NOT NULL, "eventtypeId" integer, "clientId" integer, "dealId" integer, "userId" integer, "processUserId" integer)`);
        await queryRunner.query(`CREATE TABLE "tasks" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "description" varchar NOT NULL, "start_datetime" datetime NOT NULL, "end_datetime" datetime NOT NULL, "done_datetime" datetime NOT NULL, "tasktypeId" integer, "masterUserId" integer, "createUserId" integer, "dealId" integer, "clientId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "deals" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "description" varchar NOT NULL, "amount" integer NOT NULL, "start_datetime" datetime NOT NULL, "end_datetime" datetime NOT NULL, "done_datetime" datetime NOT NULL, "dealtypeId" integer, "clientId" integer, "workerUserId" integer, "doneUserId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_events" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "description" varchar NOT NULL, "start_datetime" datetime NOT NULL, "process_datetime" datetime NOT NULL, "eventtypeId" integer, "clientId" integer, "dealId" integer, "userId" integer, "processUserId" integer, CONSTRAINT "FK_a38fe4ad7b992c1dceee3fccd7c" FOREIGN KEY ("eventtypeId") REFERENCES "eventtypes" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_2b2274cd969274843abe3219685" FOREIGN KEY ("clientId") REFERENCES "clients" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_746d6af21c8a93c794a2ba1ffa0" FOREIGN KEY ("dealId") REFERENCES "deals" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_9929fa8516afa13f87b41abb263" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_ed96e905c054665c94d866a04b4" FOREIGN KEY ("processUserId") REFERENCES "users" ("id") ON DELETE SET NULL ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_tasks" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "description" varchar NOT NULL, "start_datetime" datetime NOT NULL, "end_datetime" datetime NOT NULL, "done_datetime" datetime NOT NULL, "tasktypeId" integer, "masterUserId" integer, "createUserId" integer, "dealId" integer, "clientId" integer, CONSTRAINT "FK_7fd16101aa628a5d5938b26e927" FOREIGN KEY ("tasktypeId") REFERENCES "tasktypes" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_0312e4b3f590f83f0c80fb951bb" FOREIGN KEY ("masterUserId") REFERENCES "users" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_9c7f281292617cf9ac7d2c57a61" FOREIGN KEY ("createUserId") REFERENCES "users" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_4d5c77e1b081638da5c4248ac4a" FOREIGN KEY ("dealId") REFERENCES "deals" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_4e7cd3aff0dbd7708e02b14ecb8" FOREIGN KEY ("clientId") REFERENCES "clients" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_deals" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "description" varchar NOT NULL, "amount" integer NOT NULL, "start_datetime" datetime NOT NULL, "end_datetime" datetime NOT NULL, "done_datetime" datetime NOT NULL, "dealtypeId" integer, "clientId" integer, "workerUserId" integer, "doneUserId" integer, CONSTRAINT "FK_7fd58c2891708ea6cc46fff5e95" FOREIGN KEY ("dealtypeId") REFERENCES "dealtypes" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_4b96d900e3f444e2554042f8a56" FOREIGN KEY ("clientId") REFERENCES "clients" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_f7c4a36cfb54302fbd9e893a041" FOREIGN KEY ("workerUserId") REFERENCES "users" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_f80750134cb0a6049fb5f85a866" FOREIGN KEY ("doneUserId") REFERENCES "users" ("id") ON DELETE SET NULL ON UPDATE NO ACTION)`);
